...
export default eventHandler(async (event) => {
    ...
    const { data, error } = await client.from('project').select('id, name, year, founderName, founderSurname, description, review, companyLogo, companyImage, mostRelevant, supervisor').order('id');
